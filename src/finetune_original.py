...
def main():
    ...
    parser.add_argument('--task', default='SL_ismb',type=str)
    parser.add_argument('--cv', default='C1',type=str)
    ...
    parser.add_argument('--Node_index_path',default='./data/BKG/node_index_dic.json', type=str)
    parser.add_argument('--batch_size', type=int, default=512,
                        help='input batch size for training (default: 512)')
    parser.add_argument('--epochs', type=int, default=100,
                        help='number of epochs to train (default: 100)')
    parser.add_argument('--freeze', type=int, default=0,
                        help='freeze the model or not')
    ...
    for i in range(1,6):
        ...
        if args.freeze:
            ...
            print('training')
        linear_pred_edges=torch.nn.Sequential(torch.nn.Linear(2*args.emb_dim,args.emb_dim),torch.nn.ReLU(), torch.nn.Linear(args.emb_dim,2)).to(device)
    ...
    eval_metric_folds.loc[6,'auc']=round(eval_metric_folds['auc'].var(),4)
    eval_metric_folds.loc[6,'aupr']=round(eval_metric_folds['aupr'].var(),4)
    eval_metric_folds.loc[6,'f1']=round(eval_metric_folds['f1'].var(),4)
    eval_metric_folds.loc[6,'bacc']=round(eval_metric_folds['bacc'].var(),4)
    eval_metric_folds.loc[6,'kappa']=round(eval_metric_folds['kappa'].var(),4)
